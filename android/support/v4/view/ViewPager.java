...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C08861());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C08861 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08861() {
            }
    ...
    class C08854 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08854());
    }
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & bd_provider.FOTOS_ID;
