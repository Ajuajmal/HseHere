...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (movesPending) {
                ...
                if (removalsPending) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) moves.get(0)).holder.itemView, c01321, getRemoveDuration());
                } else {
                    c01321.run();
                }
            }
    ...
    private void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(TextTrackStyle.DEFAULT_FONT_SCALE).setDuration(getAddDuration()).setListener(new VpaListenerAdapter() {
            public void onAnimationStart(View view) {
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(TextTrackStyle.DEFAULT_FONT_SCALE).setListener(new VpaListenerAdapter() {
                public void onAnimationStart(View view) {
                ...
                public void onAnimationEnd(View view) {
                    ...
                    ViewCompat.setAlpha(newView, TextTrackStyle.DEFAULT_FONT_SCALE);
