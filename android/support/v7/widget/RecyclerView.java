...
import android.support.v7.recyclerview.C0129R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private static final Interpolator sQuinticInterpolator = new C01383();
    ...
    static class C01383 implements Interpolator {
        C01383() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0129R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0129R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0129R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0129R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0129R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mScroller.fling(0, 0, velocityX, velocityY, Integer.MIN_VALUE, Strategy.TTL_SECONDS_INFINITE, Integer.MIN_VALUE, Strategy.TTL_SECONDS_INFINITE);
            postOnAnimation();
        }
    ...
    class C09004 implements ProcessCallback {
        C09004() {
        }
    ...
    class C09015 implements Callback {
        C09015() {
        }
    ...
    class C09026 implements Callback {
        C09026() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01361();
        ...
        this.mItemAnimatorRunner = new C01372();
        this.mViewInfoProcessCallback = new C09004();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0129R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0129R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C09015());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C09026());
    }
