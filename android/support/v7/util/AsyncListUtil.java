...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C08932();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    private int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C08921();
    ...
    class C08921 implements MainThreadCallback<T> {
        C08921() {
        }
    ...
    class C08932 implements BackgroundCallback<T> {
