...
public class LogFactoryImpl extends LogFactory {
    ...
    class C08551 implements PrivilegedAction {
        C08551() {
        }
    ...
    class C08562 implements PrivilegedAction {
        private final String val$def;
        private final String val$key;

        C08562(String val$key, String val$def) {
    ...
    class C08573 implements PrivilegedAction {
        private final LogFactoryImpl this$0;
        private final ClassLoader val$cl;

        C08573(LogFactoryImpl this$0, ClassLoader val$cl) {
            this.this$0 = this$0;
            this.val$cl = val$cl;
        }
    ...
    private static ClassLoader getContextClassLoaderInternal() throws LogConfigurationException {
        return (ClassLoader) AccessController.doPrivileged(new C08551());
    }

    private static String getSystemProperty(String key, String def) throws SecurityException {
        return (String) AccessController.doPrivileged(new C08562(key, def));
    }

    private ClassLoader getParentClassLoader(ClassLoader cl) {
        try {
            return (ClassLoader) AccessController.doPrivileged(new C08573(this, cl));
        } catch (SecurityException e) {
