...
import hse.here2.config;
import java.io.IOException;

public class InstanceIDListenerService extends Service {
    static String ACTION = C0204c.fT;
    ...
    BroadcastReceiver zzaMX = new C04182(this);
    int zzaNa;
    int zzaNb;

    class C04182 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C04182(InstanceIDListenerService instanceIDListenerService) {
            this.zzaNc = instanceIDListenerService;
        }

        public void onReceive(Context context, Intent intent) {
            if (Log.isLoggable("InstanceID", 3)) {
                intent.getStringExtra(config.PROPERTY_REG_ID);
    ...
    public void zzp(Intent intent) {
        ...
        if (intent.getStringExtra("error") == null && intent.getStringExtra(config.PROPERTY_REG_ID) == null) {
            if (Log.isLoggable("InstanceID", 3)) {
