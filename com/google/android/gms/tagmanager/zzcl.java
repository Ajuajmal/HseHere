...
class zzcl implements Runnable {
    ...
    private void zzGY() {
        if (zzGX()) {
            zzbg.m255v("Start loading resource from network ...");
            String zzGZ = zzGZ();
            ...
            try {
                ...
                try {
                    ...
                    zzbg.m255v("Successfully loaded supplemented resource: " + zzd);
                    if (zzd.zzju == null && zzd.zzjt.length == 0) {
                        zzbg.m255v("No change for container: " + this.zzbhM);
                    }
                    this.zzbkg.zzI(zzd);
                    zzbg.m255v("Load resource from network finished.");
                } catch (Throwable e) {
