...
public class zzdf {
    ...
    private static double getDouble(Object o) {
        ...
        zzbg.m254e("getDouble received non-Number");
        return 0.0d;
    }
    ...
    public static zza zzR(Object obj) {
        ...
        if (obj instanceof String) {
            ...
            zzbg.m254e("Converting to Value from unknown object type: " + (obj == null ? "null" : obj.getClass().toString()));
            return zzblM;
        }
    ...
    private static long zzU(Object obj) {
        ...
        zzbg.m254e("getInt64 received non-Number");
        return 0;
    }
    ...
    private static zzde zzgu(String str) {
        try {
            ...
            zzbg.m254e("Failed to convert '" + str + "' to a number.");
            return zzblH;
        }
    }
        ...
        switch (com_google_android_gms_internal_zzag_zza.type) {
            ...
            case 3:
                if (com_google_android_gms_internal_zzag_zza.zzjz.length != com_google_android_gms_internal_zzag_zza.zzjA.length) {
                    zzbg.m254e("Converting an invalid value to object: " + com_google_android_gms_internal_zzag_zza.toString());
                    return zzblE;
                }
                ...
                return hashMap;
            case 4:
                zzbg.m254e("Trying to convert a macro reference to object");
                return zzblE;
            case 5:
                zzbg.m254e("Trying to convert a function id to object");
                return zzblE;
            case 6:
            ...
            default:
                zzbg.m254e("Failed to convert a value of type: " + com_google_android_gms_internal_zzag_zza.type);
                return zzblE;
        }
    }
}
