...
class zzj extends zzdd {
    ...
    class C11631 implements zza {
        final /* synthetic */ Context zzxh;

        C11631(Context context) {
            this.zzxh = context;
        }
    ...
    public zzj(Context context) {
        this(context, new C11631(context));
    }
                ...
                if (zzl instanceof List) {
                    for (Object zzl2 : (List) zzl2) {
                        if (zzl2 instanceof Map) {
                            ...
                            zzbg.m254e("ArbitraryPixel: additional params contains non-map: not sending partial hit: " + buildUpon.build().toString());
                            return;
                        }
                    }
                }
                zzbg.m254e("ArbitraryPixel: additional params not a list: not sending partial hit: " + buildUpon.build().toString());
                return;
            }
            String uri = buildUpon.build().toString();
            this.zzbhJ.zzFX().zzgc(uri);
            zzbg.m255v("ArbitraryPixel: url = " + uri);
            if (zzg != null) {
