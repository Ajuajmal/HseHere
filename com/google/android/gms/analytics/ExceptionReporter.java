...
public class ExceptionReporter implements UncaughtExceptionHandler {
    ...
    public ExceptionReporter(Tracker tracker, UncaughtExceptionHandler originalHandler, Context context) {
        if (tracker == null) {
            ...
            zzae.m253v("ExceptionReporter created, original handler is " + (originalHandler == null ? "null" : originalHandler.getClass().getName()));
        }
    }
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        zzae.m253v("Reporting uncaught exception: " + str);
        ...
        zziC.zziG();
        if (this.zzPa != null) {
            zzae.m253v("Passing exception to the original handler");
