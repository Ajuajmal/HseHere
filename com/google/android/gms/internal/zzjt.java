...
class zzjt extends WebView implements OnGlobalLayoutListener, DownloadListener, zzjp {
    ...
    class C05061 implements Runnable {
        ...
        C05061(zzjt com_google_android_gms_internal_zzjt) {
    ...
    public void destroy() {
        synchronized (this.zzpV) {
            ...
            zzit();
            this.zzNT = true;
            zzin.m468v("Initiating WebView self destruct sequence in 3...");
            this.zzNQ.zzii();
        }
    }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzin.m468v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzhZ() {
        synchronized (this.zzpV) {
            zzin.m468v("Destroying WebView!");
            zzir.zzMc.post(new C05061(this));
        }
    }
