...
public class zzfo {
    ...
    public void execute() {
        ...
        int zzhw = Ad.ORIENTATION_PORTRAIT.equalsIgnoreCase(this.zzDq) ? zzr.zzbE().zzhw() : Ad.ORIENTATION_LANDSCAPE.equalsIgnoreCase(this.zzDq) ? zzr.zzbE().zzhv() : this.zzDp ? -1 : zzr.zzbE().zzhx();
