...
public final class zzhf {
    ...
    zzd zzJj;
    public final zzdf zzJk = new C10991(this);
    public final zzdf zzJl = new C11002(this);
    zzjp zzpD;
    private final Object zzpV = new Object();

    class C10991 implements zzdf {
        final /* synthetic */ zzhf zzJm;

        C10991(zzhf com_google_android_gms_internal_zzhf) {
    ...
    class C11002 implements zzdf {
        final /* synthetic */ zzhf zzJm;

        C11002(zzhf com_google_android_gms_internal_zzhf) {
            this.zzJm = com_google_android_gms_internal_zzhf;
        }
            ...
            synchronized (this.zzJm.zzpV) {
                ...
                if (this.zzJm.zzEY.equals(com_google_android_gms_internal_zzhi.getRequestId())) {
                    ...
                    if (url.contains("%40mediation_adapters%40")) {
                        ...
                        zzin.m468v("Ad request URL modified to " + replaceAll);
                    }
                    this.zzJm.zzJi.zzg(com_google_android_gms_internal_zzhi);
                    return;
                }
