...
public class zziu {
    ...
    class C05002 implements OnClickListener {
        ...
        C05002(zziu com_google_android_gms_internal_zziu) {
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new OnClickListener(this) {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    zzr.zzbC().zzb(this.zzMm.mContext, Intent.createChooser(new Intent("android.intent.action.SEND").setType(HTTP.PLAIN_TEXT_TYPE).putExtra("android.intent.extra.TEXT", zzaG), "Share via"));
                }
            });
            builder.setNegativeButton(HTTP.CONN_CLOSE, new C05002(this));
            builder.create().show();
            return;
        }
