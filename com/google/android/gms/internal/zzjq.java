...
public class zzjq extends WebViewClient {
    ...
    class C05051 implements Runnable {
        ...
        C05051(zzjq com_google_android_gms_internal_zzjq) {
    ...
    public final void onLoadResource(WebView webView, String url) {
        zzin.m468v("Loading resource: " + url);
    ...
    public final void onPageFinished(WebView webView, String url) {
        synchronized (this.zzpV) {
            if (this.zzNH) {
                zzin.m468v("Blank page loaded, 1...");
                this.zzpD.zzhZ();
                return;
            }
            this.zzNI = true;
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String url) {
        zzin.m468v("AdWebView shouldOverrideUrlLoading: " + url);
        Uri parse = Uri.parse(url);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzh(parse);
    ...
    public final void zzfo() {
        synchronized (this.zzpV) {
            this.zzND = false;
            this.zzsz = true;
            zzir.runOnUiThread(new C05051(this));
        }
    }
    ...
    public void zzh(Uri uri) {
        ...
        if (list != null) {
            ...
            if (com.google.android.gms.ads.internal.util.client.zzb.zzQ(2)) {
                zzin.m468v("Received GMSG: " + path);
                for (String path2 : zze.keySet()) {
                    zzin.m468v("  " + path2 + ": " + ((String) zze.get(path2)));
                }
            }
            for (zzdf zza : list) {
        ...
        zzin.m468v("No GMSG handler found for GMSG: " + uri);
    }
    ...
    public void zzii() {
        synchronized (this.zzpV) {
            zzin.m468v("Loading blank page in WebView, 2...");
            this.zzNH = true;
