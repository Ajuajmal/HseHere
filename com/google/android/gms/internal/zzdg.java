...
public class zzdg implements zzdf {
    ...
    public JSONObject zzQ(String str) {
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m252e("The request is not a valid JSON.");
            try {
    ...
    protected JSONObject zza(zzd com_google_android_gms_internal_zzdg_zzd) {
        ...
        try {
            ...
            for (zza com_google_android_gms_internal_zzdg_zza : com_google_android_gms_internal_zzdg_zzd.zzdZ()) {
                jSONArray.put(new JSONObject().put(C0938c.ek, com_google_android_gms_internal_zzdg_zza.getKey()).put("value", com_google_android_gms_internal_zzdg_zza.getValue()));
            }
    ...
    public void zza(final zzjp com_google_android_gms_internal_zzjp, final Map<String, String> map) {
        zziq.zza(new Runnable(this) {
            ...
            public void run() {
                ...
                if (zzQ == null) {
                    com.google.android.gms.ads.internal.util.client.zzb.m252e("Response should not be null.");
                } else {
                    zzir.zzMc.post(new Runnable(this) {
                        final /* synthetic */ C04331 zzzo;
    ...
    protected zzb zzc(JSONObject jSONObject) {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                arrayList.add(new zza(optJSONObject.optString(C0938c.ek), optJSONObject.optString("value")));
            }
        }
