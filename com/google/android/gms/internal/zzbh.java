...
public class zzbh {
    ...
    class C04261 implements Comparator<String> {
        final /* synthetic */ zzbh zztt;

        C04261(zzbh com_google_android_gms_internal_zzbh) {
    ...
    class C04272 implements Comparator<com.google.android.gms.internal.zzbk.zza> {
        final /* synthetic */ zzbh zztt;

        C04272(zzbh com_google_android_gms_internal_zzbh) {
            this.zztt = com_google_android_gms_internal_zzbh;
        }
    ...
    private String zzv(String str) {
        ...
        zza zzcM = zzcM();
        Arrays.sort(split, new C04261(this));
        int i = 0;
    ...
    String zzw(String str) {
        ...
        zza zzcM = zzcM();
        PriorityQueue priorityQueue = new PriorityQueue(this.zztq, new C04272(this));
