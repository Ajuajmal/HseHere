...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    private int zzDW;
    private int zzDX;
    private float zzDY = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    class C02951 implements Runnable {
        ...
        C02951(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C02962 implements Runnable {
        ...
        C02962(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02984 implements Runnable {
        ...
        C02984(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02995 implements Runnable {
        ...
        C02995(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C03006 implements Runnable {
        ...
        C03006(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C03017 implements Runnable {
        ...
        C03017(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    private void zzfa() {
        Throwable e;
        zzin.m468v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzfb() {
        if (zzfe() && this.zzDR.getCurrentPosition() > 0 && this.zzDQ != 3) {
            zzin.m468v("AdMediaPlayerView nudging MediaPlayer");
            zzb(0.0f);
            this.zzDR.start();
    ...
    private void zzfd() {
        zzin.m468v("AdMediaPlayerView abandon audio focus");
        AudioManager zzfk = zzfk();
        if (zzfk != null && this.zzEa) {
    ...
    private void zzfh() {
        zzin.m468v("AdMediaPlayerView audio focus gained");
        this.zzEa = true;
        zzfj();
    }

    private void zzfi() {
        zzin.m468v("AdMediaPlayerView audio focus lost");
        this.zzEa = false;
        zzfj();
    }
    ...
    private void zzv(boolean z) {
        zzin.m468v("AdMediaPlayerView release");
        if (this.zzDR != null) {
            this.zzDR.reset();
            this.zzDR.release();
            this.zzDR = null;
    ...
    public void onCompletion(MediaPlayer mp) {
        zzin.m468v("AdMediaPlayerView completion");
        zzw(5);
        zzx(5);
        zzir.zzMc.post(new C02962(this));
    }
    ...
    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        ...
        zzin.m468v("AdMediaPlayerView MediaPlayer info: " + ((String) zzDN.get(Integer.valueOf(what))) + ":" + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzin.m468v("AdMediaPlayerView prepared");
        zzw(2);
        this.zzDO.zzfz();
        zzir.zzMc.post(new C02951(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        zzin.m468v("AdMediaPlayerView surface created");
        zzfa();
        zzir.zzMc.post(new C02984(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        zzin.m468v("AdMediaPlayerView surface destroyed");
        if (this.zzDR != null && this.zzEb == 0) {
            this.zzEb = this.zzDR.getCurrentPosition();
        }
        zzir.zzMc.post(new C02995(this));
        zzv(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int w, int h) {
        Object obj = 1;
        zzin.m468v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzin.m468v("AdMediaPlayerView size changed: " + width + " x " + height);
    ...
    public void pause() {
        zzin.m468v("AdMediaPlayerView pause");
        if (zzfe() && this.zzDR.isPlaying()) {
            this.zzDR.pause();
            zzw(4);
            zzir.zzMc.post(new C03017(this));
        }
        zzx(4);
    }

    public void play() {
        zzin.m468v("AdMediaPlayerView play");
        if (zzfe()) {
            this.zzDR.start();
            zzw(3);
            zzir.zzMc.post(new C03006(this));
        }
        zzx(3);
    }

    public void seekTo(int millis) {
        zzin.m468v("AdMediaPlayerView seek " + millis);
        if (zzfe()) {
    ...
    public void stop() {
        zzin.m468v("AdMediaPlayerView stop");
        if (this.zzDR != null) {
            this.zzDR.stop();
            this.zzDR.release();
            this.zzDR = null;
