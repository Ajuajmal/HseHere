...
@zzhb
public class zza {
    private static final int zzxI = Color.rgb(12, 174, HttpStatus.SC_PARTIAL_CONTENT);
    private static final int zzxJ = Color.rgb(HttpStatus.SC_NO_CONTENT, HttpStatus.SC_NO_CONTENT, HttpStatus.SC_NO_CONTENT);
