...
public class zzad extends zzz {
    ...
    private long zzaZa;
    private final Runnable zzaZb = new C05491(this);
    ...
    class C05491 implements Runnable {
        ...
        class C05481 implements Runnable {
            final /* synthetic */ C05491 zzaZf;

            C05481(C05491 c05491) {
                this.zzaZf = c05491;
            }
        ...
        C05491(zzad com_google_android_gms_measurement_internal_zzad) {
            this.zzaZe = com_google_android_gms_measurement_internal_zzad;
        }

        @MainThread
        public void run() {
            this.zzaZe.zzCn().zzg(new C05481(this));
        }
    }
