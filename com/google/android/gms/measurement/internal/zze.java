...
class zze extends zzz {
    ...
    static {
        ...
        zzaVB.put(C0204c.fH, "ALTER TABLE apps ADD COLUMN day INTEGER;");
    ...
    private boolean zza(String str, int i, com.google.android.gms.internal.zzpz.zzb com_google_android_gms_internal_zzpz_zzb) {
        ...
        try {
            ...
            contentValues.put(C0204c.fS, bArr);
            try {
    ...
    Map<Integer, List<com.google.android.gms.internal.zzpz.zzb>> zzL(String str, String str2) {
        ...
        Cursor query;
        try {
            query = getWritableDatabase().query("event_filters", new String[]{"audience_id", C0204c.fS}, "app_id=? AND event_name=?", new String[]{str, str2}, null, null, null);
            if (query.moveToFirst()) {
                do {
    ...
    Map<Integer, List<com.google.android.gms.internal.zzpz.zze>> zzM(String str, String str2) {
        ...
        try {
            query = getWritableDatabase().query("property_filters", new String[]{"audience_id", C0204c.fS}, "app_id=? AND property_name=?", new String[]{str, str2}, null, null, null);
            if (query.moveToFirst()) {
                do {
                    zzsm zzD = zzsm.zzD(query.getBlob(1));
    ...
    public zza zza(long j, String str, boolean z, boolean z2) {
        ...
        try {
            SQLiteDatabase writableDatabase = getWritableDatabase();
            query = writableDatabase.query("apps", new String[]{C0204c.fH, "daily_events_count", "daily_public_events_count", "daily_conversions_count"}, "app_id=?", new String[]{str}, null, null, null);
            try {
                if (query.moveToFirst()) {
                    ...
                    ContentValues contentValues = new ContentValues();
                    contentValues.put(C0204c.fH, Long.valueOf(j));
    ...
    public void zza(zza com_google_android_gms_measurement_internal_zza) {
        ...
        contentValues.put(C0204c.fH, Long.valueOf(com_google_android_gms_measurement_internal_zza.zzBv()));
            ...
            try {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    try {
                        ...
                        cursor2 = writableDatabase.query("raw_events", new String[]{"rowid", "name", "timestamp", C0204c.fS}, "app_id=? and metadata_fingerprint=?", new String[]{string, str2}, null, null, "rowid", null);
                        if (cursor2.moveToFirst()) {
                            do {
                                try {
    ...
    public zza zzeY(String str) {
        ...
        zzjv();
        try {
            query = getWritableDatabase().query("apps", new String[]{"app_instance_id", "gmp_app_id", "resettable_device_id_hash", "last_bundle_index", "last_bundle_start_timestamp", "last_bundle_end_timestamp", "app_version", "app_store", "gmp_version", "dev_cert_hash", "measurement_enabled", C0204c.fH, "daily_public_events_count", "daily_events_count", "daily_conversions_count", "config_fetched_time", "failed_config_fetch_time"}, "app_id=?", new String[]{str}, null, null, null);
            try {
                if (query.moveToFirst()) {
    ...
    public List<Pair<com.google.android.gms.internal.zzqb.zze, Long>> zzn(String str, int i, int i2) {
        ...
        zzx.zzcM(str);
        try {
            query = getWritableDatabase().query("queue", new String[]{"rowid", C0204c.fS}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(i));
            try {
                if (query.moveToFirst()) {
