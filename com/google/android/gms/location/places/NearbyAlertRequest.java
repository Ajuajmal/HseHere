...
public final class NearbyAlertRequest implements SafeParcelable {
    ...
    private int mPriority = bd_provider.TUTORIAL_ID;
    ...
    public String toString() {
        return zzw.zzy(this).zzg("transitionTypes", Integer.valueOf(this.zzaNC)).zzg("loiteringTimeMillis", Integer.valueOf(this.zzaPr)).zzg("nearbyAlertFilter", this.zzaPt).zzg(LogFactory.PRIORITY_KEY, Integer.valueOf(this.mPriority)).toString();
    }
