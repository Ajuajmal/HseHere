...
public class SupportPlaceAutocompleteFragment extends Fragment {
    ...
    class C05321 implements OnClickListener {
        ...
        C05321(SupportPlaceAutocompleteFragment supportPlaceAutocompleteFragment) {
    ...
    class C05332 implements OnClickListener {
        ...
        C05332(SupportPlaceAutocompleteFragment supportPlaceAutocompleteFragment) {
            this.zzaRo = supportPlaceAutocompleteFragment;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.zzaRh.setOnClickListener(c05321);
        this.zzaRj.setOnClickListener(c05321);
        this.zzaRi.setOnClickListener(new C05332(this));
        zzzF();
        return inflate;
    }
