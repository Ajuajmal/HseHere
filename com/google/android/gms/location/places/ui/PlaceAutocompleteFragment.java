...
public class PlaceAutocompleteFragment extends Fragment {
    ...
    class C05301 implements OnClickListener {
        ...
        C05301(PlaceAutocompleteFragment placeAutocompleteFragment) {
    ...
    class C05312 implements OnClickListener {
        final /* synthetic */ PlaceAutocompleteFragment zzaRn;

        C05312(PlaceAutocompleteFragment placeAutocompleteFragment) {
            this.zzaRn = placeAutocompleteFragment;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View inflate = inflater.inflate(C0286R.layout.place_autocomplete_fragment, container, false);
        this.zzaRh = inflate.findViewById(C0286R.id.place_autocomplete_search_button);
        this.zzaRi = inflate.findViewById(C0286R.id.place_autocomplete_clear_button);
        this.zzaRj = (EditText) inflate.findViewById(C0286R.id.place_autocomplete_search_input);
        OnClickListener c05301 = new C05301(this);
        this.zzaRh.setOnClickListener(c05301);
        this.zzaRj.setOnClickListener(c05301);
        this.zzaRi.setOnClickListener(new C05312(this));
        zzzF();
        return inflate;
    }
